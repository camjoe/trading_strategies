...
## Current repo-specific agent inventory
...
|---|---|---|
| Architecture, layering, dependency direction | `.github/skills/architecture-review.skill.md` | Reusable review pattern; no dedicated repo agent needed |
| Pre-commit or pre-merge audit | `.github/skills/code-review.skill.md` | Generic review capability is portable |
| Whole-area simplification or stale-code audit | `.github/skills/deep-code-review.skill.md` | Generic review capability is portable |
| README/reference/API drift | `.github/skills/docs-sync.skill.md` | Generic doc-sync capability is portable |
| Frontend-only cleanup | `.github/skills/frontend-cleanup.skill.md` | Generic frontend cleanup capability is portable |
| Generic Python cleanup | `.github/skills/python-cleanup.skill.md` | Generic Python cleanup capability is portable |
| Generic test additions | `.github/skills/test-expansion.skill.md` | Generic test-expansion capability is portable |
| Financial concept explanation | `.github/skills/finance-strategy.skill.md` | Generic domain explanation capability is portable |
| Modeling, alpha research, feature engineering | `.github/skills/python-stat-modeling.skill.md` | Generic modeling capability is portable |
| Cross-stack route/schema/UI contract work | `.github/skills/ui-api-contract.skill.md` | Start with the generic skill, move to the agent only if repo-specific UI behavior matters |
