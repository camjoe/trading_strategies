...
3. **Fill the header block** — all required fields as defined in `docs/reference/reference-doc-standard.md`.
...
- `docs/reference/reference-doc-standard.md` — authoritative header standard and section guidance
