...
def add_option_args(p: argparse.ArgumentParser, *, configure_mode: bool = False) -> None:
    ...
    p.add_argument("--option-profit-take-pct", type=float, default=None, help=LEAPS_PROFIT_TAKE_HELP)
    p.add_argument("--option-max-loss-pct", type=float, default=None, help=LEAPS_MAX_LOSS_HELP)
