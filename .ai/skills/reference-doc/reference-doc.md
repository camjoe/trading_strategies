...
3. **Fill the header block** — all required fields as defined in `docs/conventions/doc-header.md`.
...
- `docs/conventions/doc-header.md` — authoritative header standard and section guidance
