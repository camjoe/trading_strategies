...
from scripts.documentation_ui.software.registry import render_markdown


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Sync docs/reference/Software.md from docs/reference/software.json.",
    )
    ...
    parser.add_argument("--markdown", default="docs/reference/Software.md")
