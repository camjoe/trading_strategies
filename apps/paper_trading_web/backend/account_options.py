...
assert frozenset(_ROTATION_OPTIMALITY_ORDER) == OPTIMALITY_MODES, (
    f"_ROTATION_OPTIMALITY_ORDER out of sync: {OPTIMALITY_MODES}"
)
assert frozenset(_ROTATION_OVERLAY_ORDER) <= ROTATION_OVERLAY_MODES, (
    f"_ROTATION_OVERLAY_ORDER out of sync: {ROTATION_OVERLAY_MODES}"
)
