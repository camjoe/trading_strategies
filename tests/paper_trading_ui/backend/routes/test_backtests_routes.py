...
_BACKTEST_REPORT_FULL = "paper_trading_ui.backend.routes.backtests.backtest_report_full"
_RUN_BACKTEST = "paper_trading_ui.backend.routes.backtests.run_backtest"
_PREVIEW_BACKTEST_WARNINGS = "paper_trading_ui.backend.routes.backtests.preview_backtest_warnings"
_RUN_WALK_FORWARD = "paper_trading_ui.backend.routes.backtests.run_walk_forward_backtest"
