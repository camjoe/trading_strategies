...
from apps.paper_trading_ui.backend.services import ibkr_paper_monitor as service
...
def test_fetch_account_ibkr_paper_monitor_data_aggregates_db_and_artifacts(
    ...
    with patch("paper_trading_ui.backend.services.ibkr_paper_monitor.fetch_db_data") as mock_db:
        with patch(
            ...
            with patch(
                "paper_trading_ui.backend.services.ibkr_paper_monitor.fetch_governance_checks_status"
            ) as mock_governance:
                with patch(
                    "paper_trading_ui.backend.services.ibkr_paper_monitor.fetch_burn_in_status"
                ) as mock_burn_in:
