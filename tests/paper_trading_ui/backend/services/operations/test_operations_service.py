...
from apps.paper_trading_ui.backend.services import operations as services_operations
from apps.paper_trading_ui.backend.services import promotion as services_promotion
