...
class TestStrategyRegistryAndResolution:
    def test_available_strategy_ids_include_phase2_families(self) -> None:
    ...
    def test_resolve_strategy_exact_and_keyword_aliases(self) -> None:
    ...
    def test_resolve_strategy_trims_and_uses_aliases(self) -> None:
...
class TestResolveSignalClassicStrategies:
    def test_trend_buy_sell_hold(self) -> None:
    ...
    def test_mean_reversion_buy_sell_hold(self) -> None:
    ...
    def test_rsi_buy_sell_and_nan_hold(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_macd_buy_sell_and_nan_hold(self, monkeypatch: pytest.MonkeyPatch) -> None:
        history = _series_range(1, 50)
    ...
    def test_breakout_buy_sell_hold(self) -> None:
    ...
    def test_pullback_trend_buy_and_sell(self) -> None:
    ...
    def test_bollinger_buy_sell_and_zero_std_hold(self) -> None:
    ...
    def test_ma_crossover_buy_sell_and_stack_buy(self) -> None:
    ...
    def test_volatility_filtered_trend_buy_sell_and_high_vol_hold(self) -> None:
...
class TestResolveSignalProxyStrategies:
    def test_topic_proxy_rotation_buy_hold_and_sell(self) -> None:
    ...
    def test_macro_proxy_regime_buy_sell_and_missing_features_hold(self) -> None:
...
class TestResolveSignalGeneralBehavior:
    def test_default_hold_when_short_history(self) -> None:
        history = pd.Series([1.0, 2.0, 3.0])
        _assert_signal("unknown_strategy", history, "hold")

    def test_fuzz_resolve_signal_outputs_known_actions(self) -> None:
