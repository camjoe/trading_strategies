...
def test_get_indicator_function_rejects_unknown_name(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_calculate_macd_delegates_to_indicator_module(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_calculate_rs_rsi_passes_window_to_indicator_module(monkeypatch: pytest.MonkeyPatch) -> None:
