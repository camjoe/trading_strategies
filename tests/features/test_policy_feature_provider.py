...
from infrastructure.features.policy_feature_provider import (
...
class TestPolicyFeatureProviderFetchReturns:
    def test_returns_dict_with_all_etfs_on_success(self):
        ...
        with patch("infrastructure.features.policy_feature_provider.yf.download", return_value=raw):
    ...
    def test_returns_none_when_download_raises(self):
        provider = PolicyFeatureProvider()
        with patch(
            "infrastructure.features.policy_feature_provider.yf.download",
