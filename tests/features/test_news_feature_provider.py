...
from features.news_feature_provider import (
    NEWS_HEADLINE_COUNT,
...
class TestNewsFeatureProviderRss:
    ...
    def test_headlines_extracted_from_rss(self):
        ...
        with patch(
            "features.news_feature_provider.urllib.request.urlopen",
    ...
    def test_rss_breaks_at_headline_cap_per_feed(self):
        ...
        with patch("features.news_feature_provider.urllib.request.urlopen", _mock_urlopen):
            result = provider._fetch_rss_headlines("AAPL")
