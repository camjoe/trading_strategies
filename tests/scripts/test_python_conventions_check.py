"""Tests for scripts.checks.python_conventions_check."""
...
from scripts.checks.python_conventions_check import check_file, discover_python_files, run_python_conventions_check
