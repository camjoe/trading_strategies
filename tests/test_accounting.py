...
def test_compute_account_state_rejects_non_positive_qty() -> None:
...
def test_compute_account_state_rejects_non_positive_price() -> None:
...
def test_compute_account_state_rejects_invalid_side() -> None:
...
def test_compute_account_state_rejects_sell_above_holdings() -> None:
...
def test_compute_account_state_sell_all_removes_position_and_avg_cost() -> None:
...
def test_record_trade_rejects_invalid_side(conn) -> None:
...
def test_record_trade_sell_does_not_require_cash(conn) -> None:
...
def test_record_trade_uses_default_trade_time_when_missing(conn, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_load_trades_orders_by_trade_time_then_id(conn) -> None:
