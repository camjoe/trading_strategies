...
- [`docs/architecture/nav-guide.md`](nav-guide.md) — Task-oriented lookup for where to edit UI code
- [`docs/architecture/service-cookbook.md`](service-cookbook.md) — Backend service API reference
