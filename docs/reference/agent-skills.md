Write concise, reliable Agent Skills for Claude.

Learn how to write effective Skills that Claude can discover and use successfully.

Good Skills are concise, well-structured, and tested with real usage. This guide provides practical authoring decisions to help you write Skills that Claude can discover and use effectively.

For conceptual background on how Skills work, see the [Skills overview](https://www.claudeskills.org/docs/agent-skills/overview).

### [Concise is key](#concise-is-key)

The [context window](https://www.claudeskills.org/en/docs/build-with-claude/context-windows) is a public good. Your Skill shares the context window with everything else Claude needs to know, including:
...
For complete Skill structure details, see the [Skills overview](https://www.claudeskills.org/docs/agent-skills/overview#skill-structure).
...
SKILL.md serves as an overview that points Claude to detailed materials as needed, like a table of contents in an onboarding guide. For an explanation of how progressive disclosure works, see [How Skills work](https://www.claudeskills.org/docs/agent-skills/overview#how-skills-work) in the overview.
...
#### [Visual overview: From simple to complex](#visual-overview-from-simple-to-complex)
...
List required packages in your SKILL.md and verify they're available in the [code execution tool documentation](https://www.claudeskills.org/en/docs/agents-and-tools/tool-use/code-execution-tool).

### [Runtime environment](#runtime-environment)

Skills run in a code execution environment with filesystem access, bash commands, and code execution capabilities. For the conceptual explanation of this architecture, see [The Skills architecture](https://www.claudeskills.org/docs/agent-skills/overview#the-skills-architecture) in the overview.
...
For complete details on the technical architecture, see [How Skills work](https://www.claudeskills.org/docs/agent-skills/overview#how-skills-work) in the Skills overview.
...
The SKILL.md frontmatter includes only `name` (64 characters max) and `description` (1024 characters max) fields. See the [Skills overview](https://www.claudeskills.org/docs/agent-skills/overview#skill-structure) for complete structure details.

### [Token budgets](#token-budgets)

Keep SKILL.md body under 500 lines for optimal performance. If your content exceeds this, split it into separate files using the progressive disclosure patterns described earlier. For architectural details, see the [Skills overview](https://www.claudeskills.org/docs/agent-skills/overview#how-skills-work).
