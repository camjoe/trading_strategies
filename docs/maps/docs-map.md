...
| `docs/reference/public-release-readiness.md` | Current public-release posture, continuous preparation rules, and final open-source release gate | Licensing posture, strategy-publication plans, security reporting, or release requirements change |
