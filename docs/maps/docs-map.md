...
| `docs/reference/database-cleanup-roadmap.md` | Record of the completed 2026-07 full-schema cleanup, its open follow-ups, and standing schema practices | A listed follow-up is completed or a new schema-cleanup effort starts |
