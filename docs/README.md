...
- [`reference/research-persistence-review.md`](reference/research-persistence-review.md) — Program A: schema-hygiene and atomic-persistence plan for the backtest and walk-forward tables
