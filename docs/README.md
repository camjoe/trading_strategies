...
- [`implementation/`](implementation/) — per-initiative implementation guides (self-contained work orders an agent can execute end-to-end); [p2-evaluation-contract-tests.md](implementation/p2-evaluation-contract-tests.md) is the first example + template
