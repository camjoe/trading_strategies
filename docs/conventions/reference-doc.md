...
To create a new reference doc in the correct format, use the `reference-doc` skill (`.github/skills/reference-doc/SKILL.md`) or copy the relevant template from `docs/reference/TEMPLATE.notes.md` or `docs/reference/TEMPLATE.adr.md`.
