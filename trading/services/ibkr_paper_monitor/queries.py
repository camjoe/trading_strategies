...
def fetch_ibkr_paper_accounts_list(conn: sqlite3.Connection) -> list[dict[str, Any]]:
    ...
    for account in all_accounts:
        ...
        account_sleeves = sleeves.fetch_strategy_sleeves_for_account(conn, account_id=account.id)
...
def _fetch_risk_summary(conn: sqlite3.Connection, account_id: int) -> dict[str, Any]:
    ...
    # Get risk decisions
    risk_rows = sleeve_risk_decisions.fetch_sleeve_risk_decisions_for_account(conn, account_id=account_id, limit=100)
