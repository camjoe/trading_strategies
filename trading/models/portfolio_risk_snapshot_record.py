...
class PortfolioRiskSnapshotRecord:
    """Persisted portfolio_risk_snapshots row materialized from the database."""
    ...
    @classmethod
    def from_mapping(cls, values: Mapping[str, object]) -> PortfolioRiskSnapshotRecord:
        return cls(
            ...
            kill_switch_triggered=bool(values["kill_switch_triggered"]),
